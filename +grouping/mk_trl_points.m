...
for i = 1:ntexr
    ...
    if strcmpi(tex_set,'brodatz')
        namein = ['vislab-common/data/textures/brodatz/B' num2str(num) '.gif'];
        imgin = double(imread(namein));
    elseif strcmpi(tex_set,'fabric')
        namein = ['vislab-common/data/textures/fabric/FC' num2str(num) '.png'];
        imgin = double(rgb2gray(imread(namein)));
    elseif strcmpi(tex_set,'pertex')
        namein = sprintf('vislab-common/data/textures/pertex/%03d.png',num);
        imgin = double(imread(namein));
    end
