...
% RGB->LMS matrix from the CPS camera calibration (stored in shared vislab-common/data)
S = load(fullfile(fileparts(mfilename('fullpath')),'..','..','vislab-common/data','cps_rgb2lms.mat'),'lms');
lms = S.lms;
